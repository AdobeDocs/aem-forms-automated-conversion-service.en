...
You can convert a source form into an adaptive form using Automated Forms Conversion service, integrate the AEM instance with a database of your choice, fill data in the converted adaptive form, and submit it to the database using the Forms Portal.
