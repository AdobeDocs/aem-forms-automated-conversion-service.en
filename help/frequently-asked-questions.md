...
1. **Which version of AEM Forms does the Automated Forms Conversion service support?** 
 ...
 1. **Can the service be installed on-premise?** 
    ...
    <p>The service converts blank forms to adaptive forms. The service does not support filled forms and extraction of data from filled forms. Remove data and proprietary information from the forms before sending the forms to service for conversion</p> <br>
