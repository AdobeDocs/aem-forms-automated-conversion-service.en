...
1. **Does the service support all formats of PDF forms? What all languages are supported?** 
    ...
    The service can convert only English, French, German, and Spanish language forms to adaptive forms. You can translate the generated adaptive forms to another language using [AEM translation workflow.](https://helpx.adobe.com/experience-manager/6-5/forms/using/using-aem-translation-workflow-to-localize-adaptive-forms.html)</br> </br>
