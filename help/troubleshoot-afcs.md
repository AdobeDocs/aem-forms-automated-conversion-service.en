...
|**Error Message** <br> Unable to connect to the service.  <br><br>**Reason** <br> Incorrect service URL or no service URL is mentioned in Automated Forms Conversion Service cloud services. <br><br>**Resolution** <br> Correct [Service URL](configure-service.md#configure-the-cloud-service) in Automated Forms Conversion Service Cloud services.|![Unable to connect to the service.](assets/wrong-service-url-configured.png)|
...
|**Error (On-premise environments only)** <br> The **[!UICONTROL Source Language]** option does not list language of Adaptive Form. <br><br>**Reason** <br> The jcr:language property of the adaptive form is set to a English or a different language.  <br><br>**Resolution** <br> Open CRX-DE lite, navigate to /content/forms/af/<your adaptive form>, open the jcr:content node, and set value of the node to language of your choice. For the list of supported languages, see [Add localization support for non-supported locales](https://experienceleague.adobe.com/docs/experience-manager-65/forms/manage-administer-aem-forms/supporting-new-language-localization.html#add-localization-support-for-non-supported-locales). |![Unable to connect to the service.](assets/aem-forms-translation-project-language-unavailable.png)|
